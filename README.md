# <span style="color:hsl(194,80%,58%)">Spring AI MCP — Org Enterprise Assistant</span>

<img src="image/mcp-logo.png" alt="logo" width="80"/>

## <span style="color:hsl(332,80%,58%)">Table of contents</span>
...
## <span style="color:hsl(109,80%,58%)">1. 🤖 What Is MCP, and What Problem Does It Solve?</span>

### <span style="color:hsl(247,80%,58%)">The problem: bespoke function-calling per provider</span>
...
### <span style="color:hsl(24,80%,58%)">The solution: a standard client/server protocol</span>
...
### <span style="color:hsl(162,80%,58%)">How this repo is shaped around that idea</span>
...
### <span style="color:hsl(299,80%,58%)">Component diagram — client, servers, and external systems</span>
...
### <span style="color:hsl(77,80%,58%)">Sequence diagram — a representative end-to-end tool call</span>
...
<a id="modules"></a>
## <span style="color:hsl(214,80%,58%)">2. 🏗️ Modules</span>
...
<a id="tech-stack"></a>
## <span style="color:hsl(352,80%,58%)">3. 🧰 Tech Stack</span>
...
## <span style="color:hsl(129,80%,58%)">4. 🗄️ Shared Database</span>
...
<a id="running"></a>
## <span style="color:hsl(267,80%,58%)">5. 🚀 Running</span>

### <span style="color:hsl(44,80%,58%)">0. Secrets</span>
...
### <span style="color:hsl(182,80%,58%)">1. Start infrastructure</span>
...
### <span style="color:hsl(319,80%,58%)">2. Start MCP servers (separate terminals)</span>
...
### <span style="color:hsl(97,80%,58%)">Running the tests</span>

```bash
./mvnw test            # all modules — no Docker/PostgreSQL/Redis/API keys required (H2 test profiles)
```

### <span style="color:hsl(234,80%,58%)">3. Start MCP client</span>
...
### <span style="color:hsl(12,80%,58%)">4. Send a chat request</span>
...
## <span style="color:hsl(149,80%,58%)">6. 🤖 MCP Client — `mcp-client`</span>
...
### <span style="color:hsl(287,80%,58%)">REST API</span>

| Method | Path    | Body                 | Description                     |
|--------|---------|----------------------|---------------------------------|
| `POST` | `/chat` | `{"message": "..."}` | Send a message to the assistant |

### <span style="color:hsl(64,80%,50%)">MCP server connections</span>
...
### <span style="color:hsl(202,80%,58%)">`assistant.*` configuration properties</span>
...
## <span style="color:hsl(339,80%,58%)">7. 🤖 HR Service — `mcp-server-hr-service` (:8084)</span>

Manages employee leave and replacement lookups.

### <span style="color:hsl(117,80%,58%)">MCP Tools</span>
...
### <span style="color:hsl(254,80%,58%)">REST API</span>
...
### <span style="color:hsl(32,80%,58%)">Environment Variables</span>
...
### <span style="color:hsl(169,80%,58%)">`mcp.security.*` properties</span>
...
## <span style="color:hsl(307,80%,58%)">8. 🤖 Ticket Service — `mcp-server-ticket-service` (:8081)</span>
...
### <span style="color:hsl(84,80%,58%)">MCP Tools & Prompts</span>
...
### <span style="color:hsl(222,80%,58%)">REST API</span>
...
### <span style="color:hsl(359,80%,58%)">Environment Variables</span>
...
## <span style="color:hsl(137,80%,58%)">9. 🤖 Deployment Service — `mcp-server-deployment-service` (:8082)</span>
...
### <span style="color:hsl(274,80%,58%)">MCP Tools</span>
...
### <span style="color:hsl(52,80%,50%)">REST API</span>
...
### <span style="color:hsl(189,80%,58%)">Environment Variables</span>
...
## <span style="color:hsl(327,80%,58%)">10. 🤖 Notification Service — `mcp-server-notification-service` (:8083)</span>

Sends and lists notifications across channels (INTERNAL, EMAIL, SLACK).

### <span style="color:hsl(104,80%,58%)">MCP Tools</span>
...
### <span style="color:hsl(242,80%,58%)">REST API</span>
...
### <span style="color:hsl(19,80%,58%)">Environment Variables</span>
...
## <span style="color:hsl(157,80%,58%)">11. 🔐 Security & Operations (MCP Servers)</span>

All seven servers share the same security model:

### <span style="color:hsl(294,80%,58%)">Bearer Token Authentication</span>
...
### <span style="color:hsl(72,80%,58%)">Rate Limiting</span>

In-memory per-user fixed-window rate limiter (default 120 req/min). Returns `429` when exceeded.

### <span style="color:hsl(209,80%,58%)">Audit Logging</span>
...
### <span style="color:hsl(347,80%,58%)">Actuator Endpoints</span>
...
## <span style="color:hsl(124,80%,58%)">12. 🔐 Prompt Injection Security</span>

Three-layer defense is applied before any user message reaches the LLM or an MCP tool.

### <span style="color:hsl(262,80%,58%)">Layer 1 — Pre-LLM query guard (`PromptInjectionGuard`)</span>
...
### <span style="color:hsl(39,80%,58%)">Layer 2 — Spring AI `SafeGuardAdvisor`</span>
...
### <span style="color:hsl(177,80%,58%)">Layer 3 — Per-server `McpAuthFilter` and rate limiting</span>
...
### <span style="color:hsl(314,80%,58%)">Adding new attack patterns</span>
...
### <span style="color:hsl(92,80%,58%)">Disabling the guard (dev / test)</span>
...
## <span style="color:hsl(229,80%,58%)">13. 📚 MCP Services Reference</span>
...
## <span style="color:hsl(7,80%,58%)">14. 📨 Streamable HTTP — MCP Protocol</span>
...
## <span style="color:hsl(144,80%,58%)">15. 📈 Observability</span>
...
## <span style="color:hsl(282,80%,58%)">16. ✅ Best Practices Applied</span>
...
## <span style="color:hsl(59,80%,50%)">17. 🤖 Spring AI 2.0 MCP — Feature Status</span>
...
## <span style="color:hsl(197,80%,58%)">18. 🏗️ Design Patterns (GoF)</span>
...
### <span style="color:hsl(334,80%,58%)">Creational</span>
...
### <span style="color:hsl(112,80%,58%)">Structural</span>
...
### <span style="color:hsl(249,80%,58%)">Behavioral</span>
...
## <span style="color:hsl(27,80%,58%)">19. 🧰 Technology Deep Dive</span>
...
### <span style="color:hsl(79,80%,58%)">Spring MVC (spring-boot-starter-web / spring-boot-starter-webmvc)</span>
...
### <span style="color:hsl(355,80%,58%)">Model Context Protocol (MCP)</span>
...
### <span style="color:hsl(132,80%,58%)">OpenAI API (GPT models)</span>
...
### <span style="color:hsl(270,80%,58%)">Spring Data JPA + Hibernate</span>
...
### <span style="color:hsl(47,80%,50%)">PostgreSQL 18</span>
...
### <span style="color:hsl(185,80%,58%)">Flyway</span>
...
### <span style="color:hsl(322,80%,58%)">HikariCP</span>
...
### <span style="color:hsl(100,80%,58%)">Spring Cache + Redis 7</span>
...
### <span style="color:hsl(237,80%,58%)">Resilience4j 2.3.0</span>
...
### <span style="color:hsl(15,80%,58%)">Micrometer + Prometheus</span>
...
### <span style="color:hsl(152,80%,58%)">Micrometer Tracing + OpenTelemetry + Grafana Tempo</span>
...
### <span style="color:hsl(290,80%,58%)">Grafana</span>
...
### <span style="color:hsl(67,80%,50%)">Lombok</span>
...
### <span style="color:hsl(205,80%,58%)">Jakarta Bean Validation (Hibernate Validator)</span>
...
### <span style="color:hsl(342,80%,58%)">Spring Boot Actuator</span>
...
### <span style="color:hsl(120,80%,58%)">Spring Boot DevTools</span>
...
### <span style="color:hsl(257,80%,58%)">H2 (In-Memory Database for Tests)</span>
...
### <span style="color:hsl(35,80%,58%)">Spring RestClient</span>
...
### <span style="color:hsl(172,80%,58%)">Amadeus Flight API</span>
...
### <span style="color:hsl(310,80%,58%)">GitHub REST API</span>
...
### <span style="color:hsl(87,80%,58%)">Gmail REST API</span>
...
### <span style="color:hsl(225,80%,58%)">MCP Inspector</span>
...
### <span style="color:hsl(2,80%,58%)">Maven (Multi-Module Build)</span>
...
### <span style="color:hsl(140,80%,58%)">Logback + logback-spring.xml</span>
...
### <span style="color:hsl(277,80%,58%)">Docker Compose</span>
...
### <span style="color:hsl(55,80%,50%)">git-commit-id-maven-plugin</span>
...
## <span style="color:hsl(192,80%,58%)">20. 📖 MCP Deep Dive — Concepts, Wire Protocol, and the Spring AI Implementation</span>
...
### <span style="color:hsl(330,80%,58%)">20.1 The three actors: Host, Client, Server</span>
...
### <span style="color:hsl(245,80%,58%)">20.3 Lifecycle: initialize → initialized → operate</span>
...
### <span style="color:hsl(22,80%,58%)">20.4 Transports</span>
...
#### <span style="color:hsl(297,80%,58%)">20.5.1 Declaring a tool</span>
...
#### <span style="color:hsl(75,80%,58%)">20.5.2 The call and the result envelope</span>
...
#### <span style="color:hsl(212,80%,58%)">20.5.3 Context injection, sampling, elicitation, progress</span>
...
#### <span style="color:hsl(350,80%,58%)">20.5.4 Validation & the trust boundary</span>
...
### <span style="color:hsl(127,80%,58%)">20.6 Server primitive #2 — Resources</span>
...
### <span style="color:hsl(265,80%,58%)">20.7 Server primitive #3 — Prompts</span>
...
### <span style="color:hsl(42,80%,58%)">20.8 Client side: from `tools/list` to a ChatModel tool call</span>
...
### <span style="color:hsl(317,80%,58%)">20.10 Debugging & testing toolchain</span>
...
### <span style="color:hsl(95,80%,58%)">20.11 Pitfalls (all hit in this repo)</span>
...
### <span style="color:hsl(232,80%,58%)">20.12 Glossary</span>
